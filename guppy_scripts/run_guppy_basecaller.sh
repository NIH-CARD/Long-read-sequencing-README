...
do
	...
	#PLEASE NOYE THAT SETTINGS USED FOR GUPPY ARE OPTIMIZED FOR A100 GPU, 40 GB WORKING IN MIG2 MODE. YOU CHANGE THESE IF YOU ARE USING DIFFERENT GPU/MIG mode
	for mig in "${gpus[@]}"
	do
	{
